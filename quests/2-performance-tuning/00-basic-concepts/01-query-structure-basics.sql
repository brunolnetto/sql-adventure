...
(1, 'John', 'Doe', 'john@email.com', '555-1234', '123 Main St', 'New York', 'NY', '10001', 'USA'),
(2, 'Jane', 'Smith', 'jane@email.com', '555-5678', '456 Oak Ave', 'Los Angeles', 'CA', '90210', 'USA'),
(3, 'Bob', 'Wilson', 'bob@email.com', '555-9012', '789 Pine St', 'Chicago', 'IL', '60601', 'USA');

INSERT INTO orders VALUES
(1, 1, '2024-01-15', 150.00, 'completed', '123 Main St', '123 Main St', 'Customer requested fast shipping'),
(2, 2, '2024-01-20', 75.50, 'processing', '456 Oak Ave', '456 Oak Ave', 'Gift order'),
(3, 1, '2024-01-25', 200.00, 'completed', '123 Main St', '123 Main St', 'Bulk order');
...
FROM customers
WHERE country = 'USA'  -- Non-selective (most customers are in USA)
  AND city = 'New York';  -- More selective

-- BETTER: More selective condition first
SELECT customer_id, first_name, last_name, email
FROM customers
WHERE city = 'New York'  -- More selective first
