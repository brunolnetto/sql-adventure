...
INSERT INTO employees (
    first_name, last_name, email, salary, hire_date, dept_id, manager_id
) VALUES
...
SELECT
    ...
    ep.role
FROM employees AS e
INNER JOIN employee_projects AS ep ON e.emp_id = ep.emp_id
...
LEFT JOIN employee_projects AS ep ON e.emp_id = ep.emp_id
GROUP BY d.dept_id, d.dept_name
