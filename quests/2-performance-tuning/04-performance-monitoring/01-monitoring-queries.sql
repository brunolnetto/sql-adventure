...
(
    'SELECT COUNT(*) FROM orders WHERE created_date >= $1',
    2500,
    1,
    85.2,
    120,
...
(
    'SELECT * FROM orders o JOIN users u ON o.user_id = u.user_id WHERE o.status = $1',
    1200,
    50,
    45.6,
    89,
...
(
    'abc123def456',
    'SELECT * FROM orders WHERE created_date >= $1',
    2500.5,
    5000,
    25,
    '2024-01-15 10:30:00'
...
(
    'def456ghi789',
    'SELECT COUNT(*) FROM large_table WHERE complex_condition = $1',
    3500.8,
    8000,
    8,
    '2024-01-15 10:20:00'
...
SELECT
    ...
    ROUND(avg_execution_time_ms * execution_count / 1000, 2)
...
SELECT
    ...
    ROUND((COUNT(*) * 100.0 / (SELECT COUNT(*) FROM performance_logs)), 2)
...
SELECT
    ...
    ROUND(
        (COUNT(*) FILTER (WHERE execution_time_ms > 1000) * 100.0 / COUNT(*)), 2
        ...
        'recommendations', JSONB_AGG(
            ...
            CASE
                WHEN
                    ...
                    THEN 'Investigate critical slow queries'
                WHEN
                    cpu_usage > 80
                    THEN 'Consider query optimization or scaling'
                WHEN
                    memory_usage_mb > 100
                    THEN 'Review memory-intensive queries'
