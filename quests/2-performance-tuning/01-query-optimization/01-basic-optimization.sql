...
INSERT INTO customers (
    first_name, last_name, email, registration_date, total_orders
) VALUES
...
INSERT INTO products (
    name, category, price, stock_quantity, created_date
) VALUES
...
FROM customers
WHERE
    status = 'active'  -- Non-selective (most customers are active)
...
FROM customers
WHERE
    registration_date >= '2023-03-01'  -- More selective first
