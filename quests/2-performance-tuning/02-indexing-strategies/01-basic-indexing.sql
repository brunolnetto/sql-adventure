...
-- Insert sample data
INSERT INTO customers (first_name, last_name, email, registration_date, status, city, country) VALUES
('John', 'Doe', 'john.doe@email.com', '2023-01-15', 'active', 'New York', 'USA'),
('Jane', 'Smith', 'jane.smith@email.com', '2023-02-20', 'active', 'Los Angeles', 'USA'),
('Bob', 'Johnson', 'bob.johnson@email.com', '2023-03-10', 'inactive', 'Chicago', 'USA'),
('Alice', 'Brown', 'alice.brown@email.com', '2023-04-05', 'active', 'Toronto', 'Canada'),
('Charlie', 'Wilson', 'charlie.wilson@email.com', '2023-05-12', 'active', 'London', 'UK');
...
CREATE INDEX idx_customers_name_lower ON customers(LOWER(first_name || ' ' || last_name));
...
CREATE UNIQUE INDEX idx_customers_name_city ON customers(first_name, last_name, city);

-- Query to test unique constraint
SELECT first_name, last_name, city, COUNT(*)
FROM customers
