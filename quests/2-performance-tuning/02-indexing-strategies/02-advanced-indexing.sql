...
INSERT INTO articles (
    title, content, author, category, tags, published_date, view_count
) VALUES
(
    'PostgreSQL Performance Optimization',
    'Learn advanced techniques for optimizing PostgreSQL queries and improving database performance...',
    'John Smith',
    'Database',
    ARRAY['postgresql', 'performance', 'optimization'],
    '2024-01-15',
    1250
),
(
    'Introduction to Database Indexing',
    'Understanding the fundamentals of database indexing and how it affects query performance...',
    'Jane Doe',
    'Database',
    ARRAY['indexing', 'database', 'performance'],
    '2024-01-16',
    890
),
(
    'Advanced SQL Techniques',
    'Explore advanced SQL features including window functions, CTEs, and complex aggregations...',
    'Bob Johnson',
    'SQL',
    ARRAY['sql', 'advanced', 'window-functions'],
    '2024-01-17',
    1560
),
(
    'Data Modeling Best Practices',
    'Learn how to design efficient database schemas and relationships...',
    'Alice Brown',
    'Design',
    ARRAY['data-modeling', 'schema', 'relationships'],
    '2024-01-18',
    720
);

-- Insert sample products data
INSERT INTO products_advanced (
    name, description, specifications, categories, metadata
) VALUES
(
    'Gaming Laptop',
    'High-performance gaming laptop with RGB keyboard',
    '{"cpu": "Intel i9", "ram": "32GB", "gpu": "RTX 4080", "storage": "1TB SSD"}',
    ARRAY['Electronics', 'Gaming', 'Laptop'],
    '{"brand": "GamingTech", "warranty": "2 years", "rating": 4.8}'
),
(
    'Wireless Headphones',
    'Noise-cancelling wireless headphones',
    '{"brand": "AudioTech", "type": "Over-ear", "battery_life": "30 hours"}',
    ARRAY['Electronics', 'Audio', 'Wireless'],
    '{"brand": "AudioTech", "warranty": "1 year", "rating": 4.6}'
),
(
    'Office Chair',
    'Ergonomic office chair with lumbar support',
    '{"material": "Mesh", "weight_capacity": "300 lbs", "adjustable": true}',
    ARRAY['Furniture', 'Office', 'Ergonomic'],
    '{"brand": "ComfortMax", "warranty": "5 years", "rating": 4.4}'
);

-- Insert sample spatial data
INSERT INTO spatial_data (
    name, latitude, longitude, location_type, properties
) VALUES
(
    'Central Park',
    40.7829,
    -73.9654,
    'Park',
    '{"area_acres": 843, "established": 1857, "features": ["lakes", "trails", "playgrounds"]}'
),
(
    'Times Square',
    40.7580,
    -73.9855,
    'Landmark',
    '{"famous_for": "New Year celebrations", "tourist_attraction": true, "neon_signs": true}'
),
(
    'Brooklyn Bridge',
    40.7061,
    -73.9969,
    'Bridge',
    '{"length_feet": 5989, "opened": 1883, "pedestrian_access": true}'
);

-- Example 1: Full-Text Search Index
-- Create GIN index for full-text search
CREATE INDEX idx_articles_content_gin ON articles USING gin (
    TO_TSVECTOR('english', content)
);
CREATE INDEX idx_articles_title_gin ON articles USING gin (
...
FROM articles, TO_TSQUERY('english', 'performance & optimization') AS query
...
CREATE INDEX idx_products_specs_gin ON products_advanced USING gin (
    specifications
);
CREATE INDEX idx_products_metadata_gin ON products_advanced USING gin (
    metadata
);
