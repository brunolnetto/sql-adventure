...
(
    ...
    'Alice',
    'Johnson',
    'Software developer passionate about databases',
    'https://avatars.com/alice.jpg',
    '2024-01-15 16:20:00'
),
(
    2,
    ...
    'Bob',
    'Smith',
    'Full-stack developer and SQL enthusiast',
    'https://avatars.com/bob.jpg',
    '2024-01-16 11:30:00'
),
(
    3,
    ...
    'Carol',
    'Davis',
    'Data scientist and analytics expert',
    'https://avatars.com/carol.jpg',
    '2024-01-17 13:45:00'
);
...
(
    ...
    'https://logos.com/techcorp.png'
),
(
    2,
    'MobilePro',
    'Premium mobile device brand',
    'https://logos.com/mobilepro.png'
),
(
    3,
    'AccessoryMax',
    'Quality accessories provider',
    'https://logos.com/accessorymax.png'
);
...
CREATE TABLE product_catalog_denormalized (
    ...
    quantity_available INT DEFAULT 0,
    quantity_reserved INT DEFAULT 0,
    quantity_available_for_sale INT GENERATED ALWAYS AS (
...
SELECT
    ...
    us.following_count,
    us.last_activity
FROM users_normalized AS u
INNER JOIN user_profiles_normalized AS up ON u.user_id = up.user_id
LEFT JOIN
    user_preferences_normalized AS upr
    ON u.user_id = upr.user_id AND upr.preference_key = 'theme'
LEFT JOIN user_stats_normalized AS us ON u.user_id = us.user_id
...
SELECT
    ...
    COALESCE(pi.quantity_available <= pi.reorder_level, FALSE) AS needs_reorder
FROM products_normalized AS p
INNER JOIN categories_normalized AS c ON p.category_id = c.category_id
LEFT JOIN categories_normalized AS pc ON c.parent_category_id = pc.category_id
INNER JOIN brands_normalized AS b ON p.brand_id = b.brand_id
INNER JOIN product_inventory_normalized AS pi ON p.product_id = pi.product_id
