...
(
    ...
    true,
    true,
    'Laptop Pro X1 - High Performance',
    'Professional laptop with cutting-edge technology'
),
(
    2,
    ...
    false,
    'Wireless Mouse Elite',
    'Ergonomic wireless mouse for comfort'
),
(
    3,
    'USB Keyboard Pro',
    ...
    false,
    'USB Keyboard Pro',
    'Mechanical keyboard for typing enthusiasts'
);
...
SELECT
    ...
    CASE WHEN p.is_bestseller = true THEN 'Bestseller' ELSE 'Regular' END
        AS product_status
FROM products AS p
...
SELECT
    ...
    ROUND(
        ...
        / LAG(SUM(o.total_amount)) OVER (ORDER BY DATE_TRUNC('month', o.order_date)) * 100, 2
...
SELECT
    ...
    CASE
        ...
        WHEN
            ...
            THEN GREATEST(0, reorder_level - quantity_available)
        ELSE 0
    END AS suggested_order_quantity
FROM inventory_analysis
ORDER BY action_needed ASC, avg_daily_sales DESC;
