...
CREATE TABLE students (
    ...
    status VARCHAR(20) DEFAULT 'active' CHECK (status IN ('active', 'graduated', 'withdrawn', 'suspended'))
);
...
CREATE TABLE faculty (
    ...
    salary DECIMAL(10,2),
    rank VARCHAR(20) CHECK (rank IN ('assistant', 'associate', 'full', 'emeritus')),
    status VARCHAR(20) DEFAULT 'active' CHECK (status IN ('active', 'retired', 'terminated'))
);
...
CREATE TABLE student_addresses (
    ...
    address_type VARCHAR(20) NOT NULL CHECK (address_type IN ('permanent', 'temporary', 'mailing')),
...
CREATE TABLE faculty_departments (
    ...
    appointment_type VARCHAR(20) DEFAULT 'primary' CHECK (appointment_type IN ('primary', 'secondary', 'adjunct')),
...
(1, 'Computer Science', 'CS', 'Engineering Building', '555-1000', 500000.00, '1990-01-01'),
(2, 'Mathematics', 'MATH', 'Science Building', '555-1001', 300000.00, '1985-01-01'),
(3, 'Business Administration', 'BUS', 'Business Building', '555-1002', 400000.00, '1988-01-01');

INSERT INTO students VALUES
(1, 'S2024001', 'Alice', 'Johnson', 'alice.johnson@university.edu', '2000-05-15', '2024-01-15', NULL, 'active'),
(2, 'S2024002', 'Bob', 'Smith', 'bob.smith@university.edu', '1999-08-22', '2024-01-15', NULL, 'active'),
(3, 'S2024003', 'Carol', 'Davis', 'carol.davis@university.edu', '2001-03-10', '2024-01-15', NULL, 'active');

INSERT INTO faculty VALUES
(1, 'F2024001', 'Dr. John', 'Wilson', 'john.wilson@university.edu', '2020-08-15', 75000.00, 'associate', 'active'),
(2, 'F2024002', 'Dr. Sarah', 'Brown', 'sarah.brown@university.edu', '2018-01-10', 85000.00, 'full', 'active'),
(3, 'F2024003', 'Dr. Michael', 'Lee', 'michael.lee@university.edu', '2022-03-20', 65000.00, 'assistant', 'active');

INSERT INTO courses VALUES
(1, 'CS101', 'Introduction to Computer Science', 3, 'Basic concepts of programming and computer science', NULL, true),
(2, 'CS201', 'Data Structures and Algorithms', 3, 'Advanced programming concepts and algorithm design', 'CS101', true),
(3, 'MATH101', 'Calculus I', 4, 'Introduction to differential calculus', NULL, true),
(4, 'BUS101', 'Introduction to Business', 3, 'Fundamental business concepts and practices', NULL, true);

INSERT INTO sections VALUES
(1, 1, '001', 'Spring', 2024, 30, 25, '101', 'Engineering Building', '09:00:00', '10:15:00', 'MWF'),
(2, 1, '002', 'Spring', 2024, 30, 28, '102', 'Engineering Building', '10:30:00', '11:45:00', 'MWF'),
(3, 2, '001', 'Spring', 2024, 25, 20, '201', 'Engineering Building', '13:00:00', '14:15:00', 'TTh'),
(4, 3, '001', 'Spring', 2024, 35, 30, '301', 'Science Building', '09:00:00', '10:50:00', 'MWF');

INSERT INTO student_addresses VALUES
(1, 1, 'permanent', '123 Main St', 'New York', 'NY', '10001', 'USA', true),
(2, 1, 'temporary', '456 Campus Ave', 'University City', 'NY', '10002', 'USA', true),
...
SELECT 
    ...
    STRING_AGG(f.first_name || ' ' || f.last_name, ', ' ORDER BY f.last_name) as faculty_members
FROM departments d
LEFT JOIN faculty_departments fd ON d.department_id = fd.department_id AND fd.appointment_type = 'primary'
...
FROM faculty f
JOIN faculty_departments fd ON f.faculty_id = fd.faculty_id AND fd.appointment_type = 'primary'
JOIN departments d ON fd.department_id = d.department_id
LEFT JOIN sections sec ON f.faculty_id = sec.faculty_id -- Assuming faculty_id in sections
...
SELECT 
    ...
    CASE 
        WHEN COUNT(*) > 1 THEN 'VIOLATION: Student has multiple current permanent addresses'
        ELSE 'OK'
    END as status
...
(1, 'Machine Learning in Education', 'ML-EDU-2024', 'Applying ML techniques to improve student learning outcomes', '2024-01-01', '2025-12-31', 150000.00, 'active'),
(2, 'Database Performance Optimization', 'DB-PERF-2024', 'Research on optimizing database queries for large datasets', '2024-03-01', '2024-12-31', 75000.00, 'active');
...
SELECT 
    ...
    p.budget,
    ROUND(p.budget / (COUNT(DISTINCT fp.faculty_id) + COUNT(DISTINCT sp.student_id)), 2) as budget_per_participant
